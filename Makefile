...
./bin/gametest: main.o logic.o music.o gfx.o texture.o tex_list.o texture_mgr.o player.o enemy.o actor.o sprite_component.o engine.o sprite.o vec.o moveball_component.o bounce_component.o animation_component.o quad_renderer_component.o collider.o rigid_body.o physics.o dynamic_array.o
	$(CC) $(LDFLAGS) -o $@ $^
